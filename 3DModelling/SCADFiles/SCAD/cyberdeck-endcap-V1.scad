...
include <custom/library-customs.scad>
...
module BaseTri (TX,TY,TZ,COSetY) {
    ...
    right_triangle_bosl([TX,TY,TZ], align=V_UP+V_BACK+V_RIGHT, orient=ORIENT_X, center=BaseCntr);
}
...
//     //Second layers
//     color(CWh[65][1]) cuboid([BBx,BBy,BBz],rounding=0,p1=[BAx-BBx,COSetY,BAz]);
//     color(CWh[65][1]) cuboid([BBx,BBy,BBz],rounding=0,p1=[0,COSetY+BAy-BBy,BAz]);
// }
//     //First Triangle
//     BaseTri(TAx,TAy,TAz,COSetY);
//     //Second Triangle
//     translate ([0,COSetY+TAy,0]) mirror([0,90,0]) BaseTri(TAx,TAy,TAz,0);
// }
translate([225,COSetY,0]) color(CWh[0][1]) import("../PrintFiles/cyberdeck-endCap.stl");